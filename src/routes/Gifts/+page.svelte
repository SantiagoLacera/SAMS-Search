	...
	<main>
		...
		>
			...
			<div class="hero-content text-center">
				<div class="max-w-md">
					<h1 class="mb-5 text-5xl font-bold">Gifts</h1>
					<p class="mb-5 text-lg">
						This is a simple gift-list app that allows you to search for gifts by typing the name of
						the Item or Location. For Example "Smoky" or "VLT". The list is stored in local storage,
						nothing is online.
					</p>
					<div class="container">
